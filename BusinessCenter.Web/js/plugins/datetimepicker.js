              ...
              link: function link(scope, element, attrs, ngModelController) {
                  ...
                  var dataFactory = {
                      ...
                      setTime: function setTime(unixDate) {
                          ...
                          ngModelController.$setViewValue(("0" + parseInt(newDate.getMonth() + 1)).slice(-2) + "/" + ("0" + parseInt(newDate.getDate())).slice(-2) + "/" + newDate.getFullYear());
                  ...
                  var getUTCTime = function getUTCTime(modelValue) {
                      if (!modelValue) {
                          if (attrs.dateofbirth == "true") {
                              modelValue = new Date(new Date().getMonth() + 1 + '/' + new Date().getDate() + '/' + parseInt(new Date().getFullYear() - 21));
                          }
                      }
