...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        tCaption = '<div tabindex="-100" style="cursor:default" class="form-control noshadow file-caption {class}">\n' +
    ...
    FileInput.prototype = {
        ...
        setCaption: function (content, isError) {
            ...
            if (isError) {
                if (content === 'Exceed') {
                    ...
                    // alert("Exceed")
                    //  self.clear();
                    title = $('<div>' + self.msgExceed + '</div>').text();
                    out = '<span class="' + self.msgValidationErrorClass + '">' +
                    self.msgValidationErrorIcon + title + '</span>';
                }
                else if (content === 'ExtMatch') {
                    self.clear();
                    // alert(content);
                    // alert("Exceed")
                    title = $('<div>' + self.msgNotmatch + '</div>').text();
                    out = '<span class="' + self.msgValidationErrorClass + '">' +
                    self.msgValidationErrorIcon + title + '</span>';
                }
                else {
        ...
        renderBrowse: function () {
            ...
            return '<div style="cursor:pointer;" class="' + css + '"' + status + '> ' + self.browseIcon + '<span class="hidden-xs hidden-sm">' + self.browseLabel + '</span>' + ' </div>';
        },
        ...
        renderUpload: function () {
            ...
            if (!self.isUploadable || self.isDisabled) {
                ...
                content = '<a style="cursor:pointer!important;" href="' + self.uploadUrl + '" title="' + self.uploadTitle + '" class="' + css + '"' + status + '>' + self.uploadIcon + '<span class="hidden-xs hidden-sm">' + self.uploadLabel + '</span>' + '</a>';
            }
            return content;
        }
    };
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgExceed: 'File size cannot exceed 5 MB.',
        msgNotmatch: 'Documents must be in a PDF format to upload.'
    };
