        ...
        return function (collection, itemsPerPage, paginationId) {
            ...
            if (collection instanceof Array) {
                ...
                if (paginationService.isAsyncMode(paginationId)) {
                    ...
                    //This line is used for storing the page number so that it will give us the latest page number when the page is being refreshed
                    localStorage.pagenumber = paginationService.getCurrentPage(paginationId);
                }
