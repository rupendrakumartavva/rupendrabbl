...
{
    public  class SearchEntityDisplay
    {

        //Business License Records Display
        /// <summary>
        /// This method is bind the bbldata to common data list for save search list.
        /// </summary>
        ...
        /// <returns></returns>
        public  List<CommonData> GetBblRecords(int sno, int entityid, bool wishlist,ICollection<DCBC_ENTITY_BBL> bbldata )
        {
            var bblData1 = new List<CommonData>();
            try
            {

                var bbl = (from bblData in bbldata
                               where bblData.DCBC_ENTITY_ID == entityid
                               select bblData);
                //CultureInfo cultureInfo = Thread.CurrentThread.CurrentCulture;
                //TextInfo textInfo = cultureInfo.TextInfo;
                foreach (var bblData in bbl)
                {
                    //if (bblData.B1_APPL_STATUS.ToUpper().Trim() == "ACTIVE" || bblData.B1_APPL_STATUS.ToUpper().Trim() == "READY TO RENEW" ||
                    ...
                    var getbl = new CommonData
                    {
                        ...
                        LeftNameResultTop = bblData.OwnrApplicant_BUSINESS_NAME == null ? "" : bblData.OwnrApplicant_BUSINESS_NAME.ToUpper().Trim() == "NA" ? "" : CultureInfo.CurrentCulture.TextInfo.ToTitleCase(bblData.OwnrApplicant_BUSINESS_NAME.ToLower().Trim()),
                        LeftNameMiddle = "Trade Name : ",
                        LeftNameResultMiddle = bblData.Attr_TRADE_NAME == null ? "" : bblData.Attr_TRADE_NAME.ToUpper().Trim() == "NA" ? "" : bblData.Attr_TRADE_NAME.Trim(),

                        LeftNameBottom = "License Category : ",
                        LeftNameResultBottom = bblData.License_Category == null ? "" : bblData.License_Category.ToUpper().Trim() == "NA" ? "" : bblData.License_Category.Trim(),
                        LeftNameMiddleLabel1 = "Licensee Name : ",
                        LeftNameMiddle1Text = bblData.OwnrApplicant_FNAME == null ? "" : bblData.OwnrApplicant_FNAME == "NA" ? "" :
                        bblData.OwnrApplicant_FNAME == "N/A" ? "" :
                        bblData.OwnrApplicant_FNAME.Trim()
                        + (bblData.OwnrApplicant_MNAME == null ? "" : " " + CultureInfo.CurrentCulture.TextInfo.ToTitleCase(bblData.OwnrApplicant_MNAME.ToLower().Trim())) +
                        (bblData.OwnrApplicant_LNAME == null ? "" : " " + CultureInfo.CurrentCulture.TextInfo.ToTitleCase(bblData.OwnrApplicant_LNAME.ToLower().Trim())),
                        MiddleNameTop = "Premise Address : ",
                        MiddleNameResultTop = ((bblData.B1_HSE_NBR_START == null ? "" : bblData.B1_HSE_NBR_START.ToString().ToUpper().Trim() == "NA" ? "" : bblData.B1_HSE_NBR_START.ToString().ToUpper().Trim()) +
                        (bblData.B1_HSE_NBR_END == null ? "" : bblData.B1_HSE_NBR_END.ToString().ToUpper().Trim() == "NA" ? "" : "-" + bblData.B1_HSE_NBR_END.ToString().ToUpper().Trim()) +
                       (bblData.B1_HSE_FRAC_NBR_START == null ? "" : bblData.B1_HSE_FRAC_NBR_START.ToUpper().Trim() == "NA" ? "" : " " + bblData.B1_HSE_FRAC_NBR_START.ToString().ToUpper().Trim()) +
                          (bblData.B1_HSE_FRAC_NBR_END == null ? "" : bblData.B1_HSE_FRAC_NBR_END.ToUpper().Trim() == "NA" ? "" : " " + bblData.B1_HSE_FRAC_NBR_END.ToUpper().Trim()) +
                             (bblData.B1_UNIT_START == null ? "" : bblData.B1_UNIT_START.ToUpper().Trim() == "NA" ? "" : " Suite#" + bblData.B1_UNIT_START.ToUpper().Trim()) +
                             (bblData.B1_STR_NAME == null ? "" : bblData.B1_STR_NAME.ToUpper().Trim() == "NA" ? "" : " " + " " + bblData.B1_STR_NAME.ToUpper().ToUpper().Trim()) +
                             ...
                             (bblData.B1_STR_SUFFIX_DIR == null ? "" : bblData.B1_STR_SUFFIX_DIR.ToUpper().Trim() == "NA" ? "" : " " + bblData.B1_STR_SUFFIX_DIR.ToUpper().Trim()) +
                              (bblData.B1_SITUS_CITY == null ? "" : bblData.B1_SITUS_CITY.ToUpper().Trim() == "NA" ? "" : " " + bblData.B1_SITUS_CITY.ToUpper().Trim()) +
                              (bblData.B1_SITUS_STATE == null ? "" : bblData.B1_SITUS_STATE.ToUpper().Trim() == "NA" ? "" : " " + bblData.B1_SITUS_STATE.ToUpper().Trim()) +
                              (bblData.B1_SITUS_ZIP == null ? "" : bblData.B1_SITUS_ZIP.ToUpper().Trim() == "NA" ? "" : " " + bblData.B1_SITUS_ZIP.ToUpper().Trim())).Replace("  ", " ").Replace("  ", " "),
                        RightNameTop = "License Number : ",
                        RightNameResultTop = bblData.B1_ALT_ID == null ? "" : bblData.B1_ALT_ID.ToUpper().Trim() == "NA" ? "" : bblData.B1_ALT_ID.Trim(),
                        ...
                        RightNameResultMiddle2 = (bblData.B1_APPL_STATUS == null ? "" : bblData.B1_APPL_STATUS.ToUpper().Trim() == "NA" ? "" :
                        bblData.B1_APPL_STATUS.ToUpper().Trim() == "READY TO RENEW" ? "Active" :
                        bblData.B1_APPL_STATUS.ToUpper().Trim() == "READY TO BATCH PRINT" ? "Active" :
                        ...
                        ExpantionResult1 = bblData.License_Category_Full == null ? "" : bblData.License_Category_Full.ToUpper().Trim() == "NA" ? "" : bblData.License_Category_Full.Trim()
                    };
                    bblData1.Add(getbl);
                }
        ...
        //Corporate Registration Section Records Display
        /// <summary>
        /// This method is bind the corpdata to common data list for save search list.
        /// </summary>
        /// <param name="sno"></param>
        /// <param name="entityid"></param>
        /// <param name="wishlist"></param>
        ...
        /// <returns></returns>
        public  List<CommonData> GetCorpRecords(int sno, int entityid, bool wishlist,ICollection<DCBC_ENTITY_CORP> corpdata )
        {
            try{

                var corpfields = (from corpData in corpdata
                                              where corpData.DCBC_ENTITY_ID == entityid
                                              select new
                                              {
                                ...
                                return corpfields.Select(corpData => new CommonData
                                {
                                    id = sno,
                                    WishList = wishlist,
        ...
        //Alcoholic Beverage License Section Records Display
        /// <summary>
        /// This method is bind the abradata to common data list for save search list.
        /// </summary>
        /// <param name="sno"></param>
        /// <param name="entityid"></param>
        /// <param name="wishlist"></param>
        ...
        /// <returns></returns>
        public  List<CommonData> GetAbraRecords(int sno, int entityid, bool wishlist,ICollection<DCBC_ENTITY_ABRA>  abradata)
        {
            var abra = (from data in abradata
                        where data.DCBC_ENTITY_ID == entityid
                        select data);
            return abra.Select(abraData => new CommonData
            {
                id = sno,
                WishList = wishlist,
        ...
        //Professional License Section Records Display
        /// <summary>
        /// This method is bind the opladata to common data list for save search list.
        /// </summary>
        /// <param name="sno"></param>
        /// <param name="entityid"></param>
        /// <param name="wishlist"></param>
        ...
        /// <returns></returns>
        public  List<CommonData> GetOplaRecords(int sno, int entityid, bool wishlist,ICollection<DCBC_ENTITY_OPLA> opladata )
        {
            var oplaData1 = new List<CommonData>();
            var opla = (from data in opladata
                        where data.DCBC_ENTITY_ID == entityid
                        select data);
            foreach (var oplaData in opla)
            {
                    ...
                    LeftNameResultTop =
                        (oplaData.Licensee_Name_1 == null
                            ...
                            : oplaData.Licensee_Name_1.ToUpper().Trim() == "NA"
                                ? ""
                                : CultureInfo.CurrentCulture.TextInfo.ToTitleCase(oplaData.Licensee_Name_1.ToLower().Trim())) +
                        (oplaData.Licensee_Name_2 == null
                            ? ""
                            : oplaData.Licensee_Name_2.ToUpper().Trim() == "NA"
                                ? ""
                                : " " + CultureInfo.CurrentCulture.TextInfo.ToTitleCase(oplaData.Licensee_Name_2.ToLower().Trim())) +
                        (oplaData.Licensee_Name_3 == null
                            ? ""
                            : oplaData.Licensee_Name_3.ToUpper().Trim() == "NA"
                                ? ""
                                : " " + CultureInfo.CurrentCulture.TextInfo.ToTitleCase(oplaData.Licensee_Name_3.ToLower().Trim())) +
                        (oplaData.Licensee_Name_4 == null
                            ...
                            : oplaData.Licensee_Name_4.ToUpper().Trim() == "NA"
                                ...
                                : oplaData.Licensee_Name_4.Length == 0
                                    ? ""
                                    : ", " + CultureInfo.CurrentCulture.TextInfo.ToTitleCase(oplaData.Licensee_Name_4.ToLower().Trim()) + "."),
                ...
                getOpla.RightNameResultMiddle2 = oplaData.LICENSE_STATUS_CODE == null ? "" : oplaData.LICENSE_STATUS_CODE.ToUpper().Trim() == "NA" ? "" :
               oplaData.LICENSE_STATUS_CODE.ToUpper().Trim() == "A" ? "Active" : "Unknown";
                getOpla.Expantion1 = "LICENSE BOARD : ";
                getOpla.ExpantionResult1 = oplaData.License_Board == null ? "" : oplaData.License_Board.ToUpper().Trim() == "NA" ? "" : oplaData.License_Board.Trim();

                getOpla.LeftNameMiddleLabel1 = "License Type : ";
                getOpla.LeftNameMiddle1Text = oplaData.License_Type == null ? "" : oplaData.License_Type.ToUpper().Trim() == "NA" ? "" : CultureInfo.CurrentCulture.TextInfo.ToTitleCase(oplaData.License_Type.ToLower().Trim());
        ...
        //Certified Business Enterprise Section Records Display
        /// <summary>
        /// This method is bind the cbedata to common data list for save search list.
        /// </summary>
        /// <param name="sno"></param>
        /// <param name="entityid"></param>
        /// <param name="wishlist"></param>
        ...
        /// <returns></returns>
        public  List<CommonData> GetCbeRecords(int sno, int entityid, bool wishlist,ICollection<DCBC_ENTITY_CBE> cbedata )
        {
            var cbeData1 = new List<CommonData>();
            try
            {
                var cbe = (from data in cbedata
                            where data.DCBC_ENTITY_ID == entityid
                            select data);
                foreach (var cbeData in cbe)
                {
                    var getcbe = new CommonData
                    {
                        ...
                        LeftNameResultTop = cbeData.BusinessName == null ? "" : cbeData.BusinessName.ToUpper().Trim() == "NA" ? "" : CultureInfo.CurrentCulture.TextInfo.ToTitleCase(cbeData.BusinessName.ToLower().Trim()),
                        LeftNameMiddle = "CBE Number : ",
                        LeftNameResultMiddle = cbeData.LSDBE_Number == null ? "" : cbeData.LSDBE_Number.ToUpper().Trim() == "NA" ? "" : cbeData.LSDBE_Number.Trim(),
                        LeftNameBottom = "Preference Points : ",
                        LeftNameResultBottom =
                            (cbeData.RefPoints == null ? "" : cbeData.RefPoints.ToString().ToUpper().Trim() == "NA" ? "" : cbeData.RefPoints.ToString().Trim()),
                        MiddleNameTop = "Business Address : ",
                        MiddleNameResultTop = (cbeData.BusinessAddress == null ? "" : cbeData.BusinessAddress.ToUpper().Trim() == "NA" ? "" : cbeData.BusinessAddress.Trim()).Replace("  ", " ").Replace("  ", " "),
                        ...
                        RightNameResultBottom = cbeData.BusinessStructure == null ? "" : cbeData.BusinessStructure.ToUpper().Trim() == "NA" ? "" : cbeData.BusinessStructure.Trim(),
                        Expantion1 = "COMPANY DESCRIPTION : ",
                        ExpantionResult1 = cbeData.BusinessDescription == null ? "" : cbeData.BusinessDescription.ToUpper().Trim() == "NA" ? "" : cbeData.BusinessDescription.Trim(),

                        Expantion2 = "PREFERENCE POINTS DETAIL : ",
                        ExpantionResult2 = (cbeData.RefPointsDesc == null ? "" : cbeData.RefPointsDesc.ToUpper().Trim() == "NA" ? "" : cbeData.RefPointsDesc.Trim()).Replace("  ", " "),
                        Expantion3 = "BUSINESS CONTACT : ",
                        ExpantionResult3 = cbeData.BusinessContact == null ? "" : cbeData.BusinessContact.ToUpper().Trim() == "NA" ? "" : cbeData.BusinessContact.Trim(),
                        Expantion4 = "BUSINESS PHONE : ",
                        ExpantionResult4 = cbeData.BusinessPhone == null ? "" : cbeData.BusinessPhone.ToUpper().Trim() == "NA" ? "" : cbeData.BusinessPhone.Trim(),
                        Expantion5 = "BUSINESS EMAIL : ",
                        ExpantionResult5 = cbeData.BusinessEmail == null ? "" : cbeData.BusinessEmail.ToUpper().Trim() == "NA" ? "" : cbeData.BusinessEmail.Trim(),
                        LastUpdateDateName = "Last Retrieved On : ",
        ...
        //public static List<CommonData> GetBblRecords1(int sno, int entityid, bool wishlist, int _ExcededCount)
        //{
        //    var bblData1 = new List<CommonData>();
        //    try
        //    {
        //        if (_ExcededCount <=100)
        //        {
        //            var bbl = (from bblData in SearchResultData.BblData.AsQueryable()
        //                       where bblData.DCBC_ENTITY_ID == entityid
        //                       select bblData);
        //            //CultureInfo cultureInfo = Thread.CurrentThread.CurrentCulture;
        //            //TextInfo textInfo = cultureInfo.TextInfo;
        ...
        //                    MiddleNameResultTop = ((bblData.B1_HSE_NBR_START == null ? "" : bblData.B1_HSE_NBR_START.ToString().ToUpper().Trim() == "NA" ? "" : bblData.B1_HSE_NBR_START.ToString().ToUpper().Trim()) +
        //                    (bblData.B1_HSE_NBR_END == null ? "" : bblData.B1_HSE_NBR_END.ToString().ToUpper().Trim() == "NA" ? "" : "-" + bblData.B1_HSE_NBR_END.ToString().ToUpper().Trim()) +
        //                     (bblData.B1_HSE_FRAC_NBR_START == null ? "" : bblData.B1_HSE_FRAC_NBR_START.ToUpper().Trim() == "NA" ? "" : " " + bblData.B1_HSE_NBR_START.ToString().ToUpper().Trim()) +
        //                      (bblData.B1_HSE_FRAC_NBR_END == null ? "" : bblData.B1_HSE_FRAC_NBR_END.ToUpper().Trim() == "NA" ? "" : " " + bblData.B1_HSE_FRAC_NBR_END.ToUpper().Trim()) +
        //                         (bblData.B1_UNIT_START == null ? "" : bblData.B1_UNIT_START.ToUpper().Trim() == "NA" ? "" : " Suite#" + bblData.B1_UNIT_START.ToUpper().Trim()) +
        //                         (bblData.B1_STR_NAME == null ? "" : bblData.B1_STR_NAME.ToUpper().Trim() == "NA" ? "" : " " + " " + bblData.B1_STR_NAME.ToUpper().ToUpper().Trim()) +
        //                         (bblData.B1_STR_SUFFIX == null ? "" : bblData.B1_STR_SUFFIX.ToUpper().Trim() == "NA" ? "" : " " + bblData.B1_STR_SUFFIX.ToUpper().Trim()) +
