...
namespace BusinessCenter.Admin.Helpers
{
    public static class CustomImageHtmlHelpers
    {
        ...
        {
            return ImageLink(html, imagePath, alt, cssClass, action, controllerName, null);
        }
