...
{
      [TestClass]
    public class MasterCategoryPhysicalLocationServiceTest
    {
        ...
        public void GetAllCategoryPhysicallocationsTest()
        {
            ...
            //Act 
            var physicalLocationRows = _masterCategoryPhysicalLocationTestService.GetAllCategoryPhysicallocations();
        ...
        {
            var submissionApplicationEntity = new SubmissionApplication { PrimaryID = "6C548EBE-59ED-40B8-BEBE-EDF79149295D" };
            //Act 
            var physicalLocationRows = _masterCategoryPhysicalLocationTestService.FindCategoryPhysicallocationsById(submissionApplicationEntity);
        ...
        public void FindBy_PassString_CategoryPhysicallocationsTest()
        {
            ...
            //Act 
            var physicalLocationRows = _masterCategoryPhysicalLocationTestService.FindCategoryPhysicallocationsById("6C548EBE-59ED-40B8-BEBE-EDF79149295D");
        ...
        {
            var submissionApplicationEntity = new SubmissionApplication
            {
            ...
            //Act 
            var physicalLocationRows = _masterCategoryPhysicalLocationTestService.GetAllScreeningQuestions(submissionApplicationEntity);
        ...
        public void UpdatePhysicalLocation_ExitingOne_Retrun_Test()
        {
            ...
            //Act 
            var physicalLocationRows = _masterCategoryPhysicalLocationTestService.InsertUpdatePhysicalLocation(physicalLocationUpdate);
        ...
        public void InsertPhysicalLocation_Retrun_Test()
        {
            ...
            //Act 
            var physicalLocationRows = _masterCategoryPhysicalLocationTestService.InsertUpdatePhysicalLocation(physicalLocationInsert);
        ...
        {
            var submissionApplicationEntity = new SubmissionApplication { ActivityID = "668F4B68-8437-431F-9052-60809E556028", PrimaryID = "16FD71A3-7DD7-4B65-A006-777691BCB7FC", Secondary = "" };
            //Act 
            var physicalLocationRows = _masterCategoryPhysicalLocationTestService.GetAllScreeningQuestions(submissionApplicationEntity);
